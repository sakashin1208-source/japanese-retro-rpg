/**
 * ==========================================================================
 * 妖幻奇譚 〜もののけ草子〜 全章完全統合ゲームデータ定義
 * (第一章・第二章・第三章完結編 / 敵魔物50種・全9大ボス・三神具対応)
 * ==========================================================================
 */
...
const GAME_DATA = {
  ...
  // 技・術データ
  skills: {
    iai: { name: '居合い一閃', mpCost: 3, type: 'physical', target: 'enemy_single', power: 1.6, desc: '神速の抜刀術。敵単体に大打撃を与える。', effectType: 'slash' },
    shinku_ha: { name: '真空波', mpCost: 6, type: 'physical', target: 'enemy_all', power: 1.15, desc: '刀から放つ突風の刃で敵全体を一掃する。', effectType: 'wind' },
    fujin_ranbu: { name: '風刃乱舞', mpCost: 8, type: 'physical', target: 'enemy_single', power: 2.3, desc: '疾風怒濤の連続斬撃。会心の一撃が出やすい。', effectType: 'slash_heavy' },
    meikyo_shisui: { name: '明鏡止水', mpCost: 6, type: 'buff_self', target: 'self', power: 1.5, desc: '心を研ぎ澄まし、自身の攻撃力と素早さを高める。', effectType: 'buff_atk_spd' },
    tensho_fujin: { name: '奥義・天翔風塵斬', mpCost: 14, type: 'physical', target: 'enemy_all', power: 2.6, desc: '風神無想流の究極奥義。天を裂く巨大竜巻で全体を粉砕。', effectType: 'tornado' },

    shinki_chiyu: { name: '神気治癒', mpCost: 4, type: 'heal', target: 'ally_single', power: 50, desc: '清らかな祈りで味方一人のHPを中回復する。', effectType: 'heal' },
    hama_hikari: { name: '破魔の光', mpCost: 5, type: 'magical', target: 'enemy_single', power: 1.8, desc: '神聖な光弾を放ち、妖怪を浄化する。', effectType: 'holy' },
    kaen_fu: { name: '火炎の符', mpCost: 8, type: 'magical', target: 'enemy_all', power: 1.35, desc: '霊符から紅蓮の炎を巻き起こし、敵全体を焼き払う。', effectType: 'fire' },
    kiyome_kekkai: { name: '清めの結界', mpCost: 7, type: 'buff_all', target: 'ally_all', power: 1.35, desc: '神木千歳杉の結界を張り、味方全体の防御力を高める。', effectType: 'buff_def_all' },
    shinki_daichiyu: { name: '神気大治癒', mpCost: 10, type: 'heal_all', target: 'ally_all', power: 65, desc: '広範囲に神気を降らせ、味方全員のHPを回復する。', effectType: 'heal' },
    tenkei_joka: { name: '秘術・天恵浄化光', mpCost: 18, type: 'magical_revive', target: 'enemy_all', power: 2.8, desc: '天神の光柱を降臨させ、敵全体を浄化し倒れた味方を蘇生。', effectType: 'holy_pillar' },

    shuriken: { name: '手裏剣乱舞', mpCost: 4, type: 'physical', target: 'enemy_all', power: 1.15, desc: '無数の手裏剣を投擲し、敵全体を素早く攻撃する。', effectType: 'slash' },
    raiton: { name: '雷遁の術', mpCost: 7, type: 'magical', target: 'enemy_single', power: 2.1, desc: '秘伝の印を結び、激しい雷光で敵単体を貫く。', effectType: 'thunder' },
    kagenui: { name: '影縫いの術', mpCost: 5, type: 'physical', target: 'enemy_single', power: 1.45, desc: '影を刺して動きを封じ、急所に一撃を見舞う。', effectType: 'slash' },
    kawarimi: { name: '変わり身の術', mpCost: 6, type: 'buff_self', target: 'self', power: 1.0, desc: '丸太と身を入れ替え、敵の攻撃を確実に回避する。', effectType: 'evasion' },
    suiton: { name: '水遁・濁流波', mpCost: 10, type: 'magical', target: 'enemy_all', power: 1.8, desc: '激しい大津波を呼び寄せ、敵全体を押し流す。', effectType: 'water' },
    midare_chidori: { name: '禁術・月影乱れ千鳥', mpCost: 15, type: 'magical', target: 'enemy_single', power: 3.2, desc: '紫電を両手に纏い、千羽の鳥の如き速度で急所を連撃する。', effectType: 'purple_lightning' }
  },
  ...
  enemies: {
    ...
    ibaraki: {
      ...
      exp: 950,
      money: 1500,
      spriteKey: 'boss_ibaraki',
      isBoss: true,
      actions: [
        { type: 'dark_slash', name: '暗黒鬼腕斬', rate: 45, power: 1.8 },
        { type: 'fire', name: '羅生門の劫火', rate: 35, power: 1.5 },
        { type: 'curse', name: '怨念の縛り', rate: 20, power: 1.3 }
      ]
    },
    musokage: {
      id: 'musokage',
      ...
      exp: 1200,
      money: 2000,
      spriteKey: 'boss_musokage',
      isBoss: true,
      actions: [
        { type: 'slash_heavy', name: '真・風塵絶命剣', rate: 50, power: 2.0 },
        { type: 'tornado', name: '神速竜巻刃', rate: 30, power: 1.6 },
        { type: 'buff_self', name: '無想の極意', rate: 20, power: 1.5 }
      ]
    },
    shin_youko: {
      id: 'shin_youko',
      ...
      exp: 3000,
      money: 5000,
      spriteKey: 'boss_shin_youko',
      isBoss: true,
      actions: [
        { type: 'foxfire', name: '天変地異・九曜紅蓮火', rate: 35, power: 2.2 },
        { type: 'curse', name: '千年の怨嗟・常夜の門', rate: 30, power: 1.8 },
        { type: 'thunder', name: '神変万化・紫電天誅', rate: 20, power: 1.9 },
        { type: 'holy_pillar', name: '天狐の神光', rate: 15, power: 2.0 }
      ]
    }
  },
  ...
  // 街人・NPCデータ (全章 17名固有スプライト設定)
  npcs: [
    // 第一章 (10名)
    { id: 'elder', chapter: 1, name: '村長（むらおさ）', x: 12, y: 10, spriteKey: 'npc_village_head', messages: ['疾風殿、小夜殿、朧殿……よくぞ参られた。', '常夜の瘴気により森の妖怪たちが狂暴化しておる。東の古社の妖狐を鎮めてくだされ！'] },
